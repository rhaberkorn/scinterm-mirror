// Copyright 2012-2016 Mitchell mitchell.att.foicica.com.
...
PRectangle Window::GetPosition() {
  return PRectangle(0, 0, wid ? getmaxx(_WINDOW(wid)) : 0,
                          wid ? getmaxy(_WINDOW(wid)) : 0);
}
/**
...
public:
  ...
  /**
   * Repaints the Scintilla window without updating the physical screen
   * (without `doupdate()`).
